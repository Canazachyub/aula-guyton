// ==========================================================================
// UNICA capa de datos del aula. Ningun componente importa el mock ni lee
// datos por su cuenta: todo pasa por aqui (ver docs/GUIA_FRONTEND.md seccion 4).
//
// Hoy resuelve contra datos/mock.js con un retardo artificial de ~300 ms para
// que los estados de carga de la UI sean reales. En la Fase 2 cada funcion se
// reescribe como fetch() contra el Web App de Google Apps Script manteniendo
// EXACTAMENTE las mismas firmas y formas de respuesta — solo cambia este archivo.
//
// Convenciones:
